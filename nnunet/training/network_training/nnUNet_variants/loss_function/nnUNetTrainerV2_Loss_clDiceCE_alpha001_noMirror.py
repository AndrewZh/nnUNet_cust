...
class nnUNetTrainerV2_Loss_clDiceCE_alpha001_noMirror(nnUNetTrainerV2):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, fp16=False, ece=False):
        super().__init__(plans_file, fold, output_folder, dataset_directory, batch_dice, stage, unpack_data,
                         deterministic, fp16, ece)
        self.loss = DC_and_CE_loss({'do_bg': False, 'batch_dice': self.batch_dice, 'alpha': 0.01}, {}, clDice=True)
